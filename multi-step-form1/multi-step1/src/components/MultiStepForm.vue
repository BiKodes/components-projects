    ...
    <div class="container">
        <article>
            ...
            <section :class="animation">
                ...
                <div class="actions">   
                    <button v-if="activeStep +1 < formSteps.length -1" 
                        @click.prevent="checkFields"
                    >
                        Next
                    </button>
                    <button v-if="activeStep +1 === formSteps.length -1"
            ...
            formSteps: [
                {
                    ...
                    fields: [
                        {
                            label: "What does Mr.Olympia stand for?.", value:'', valid: true, 
                                pattern: /.+/
                        },
                        {
                            label: "Who has won it many times ever?", value: '', valid: true,
                                pattern: /.+/ 
                        },
                        {
                            label: "What are the most difficult parts to build?", value: '', 
                                valid: true, pattern: /.+/        
                        }
                    ]
                },
                                                                                                            
                {
                    ...
                    fields: [
                        {
                            label: "Why is the 2021 Olympia taking place in Orlando, FL?", value: '',
                                valid: true, pattern: /.+/
                        },
                        {
                            label: "What is the schedule for the 2021 Olympia?", value: '',
                                valid: true, pattern: /.+/
                        },
                        {
                            label: " I would like to watch the 2020 Olympia. How and where can I do that?",
                                value: '', valid: true, pattern: /.+/
                        }
                    ]
                },

                {
                    ...
                    fields: [
                        ...
                        {
                            label: "Your Email", value: '', valid: true,
                                pattern: /^[^\s@]+@[^\s@]+\.[^\s@]+$/ 
                        }
                    ]
                },
